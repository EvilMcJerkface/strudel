 ...
 * threads/servers at the same time. Thus, it should be designed so that they do
 * not conflict with each other: e.g., inserting mutually disjoint subsets of
 * the data.
 * <p>
 * How data should be partitioned into such subsets depends on the type of the
 * database.
 * 
 * @author tatemura
 *
 ...
 * @param
 *            <P>
 *            type of a parameter for one population set
 */
@ThreadSafe
