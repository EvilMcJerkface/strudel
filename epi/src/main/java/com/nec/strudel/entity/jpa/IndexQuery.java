...
public final class IndexQuery {
	...
	private final Map<IndexKey, QueryExec> getExecs =
			new HashMap<IndexKey, QueryExec>();
	...
	public static class IndexKey {
		...
		public boolean equals(Object obj) {
			...
			if (obj instanceof IndexKey) {
				...
				return this.entityClass.equals(k.entityClass)
						&& this.property.equals(k.property);
			}
			return false;
		}
		@Override
	...
	public static abstract class QueryExec {
