...
public class KeyGeneratorType {
	/**
	 * When the key generation counter
	 * is the only member of the group,
	 * the name can be omitted. Then, this value is used
	 * as a default name.
	 */
	...
	/**
	 * The key generation counter is maintained outside of
	 * the entity's group. It conforms a group by itself.
	 */
	...
	/**
	 * The key generation counter is maintained inside of
	 * the entity's group. The counter is updated in the
	 * transaction that inserts the entity.
	 */
	public static KeyGeneratorType inGroup(EntityInfo entity, KeyFinder keyFinder,
			KeySetter keySetter) {
	...
	/**
	 * Gets the key that identify a key-generation
	 * counter. The combination of this key and
	 * a value generated by the key-generation counter
	 * must be globally unique in the database.
	 * @param entity an entity for which part of its
	 * key is generated by the key-generation counter.
	 */
	...
	/**
	 * Sets the generated value by a key-generation
	 * counter to the entity.
	 * @param entity
	 * @param generatedKey
	 */
