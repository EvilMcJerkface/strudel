...
public enum DataParam implements ParamName {
    ...
    /**
     * The number of private items populated for each user.
     */
    ITEMS_PER_USER,
    ...
    /**
     * The number of submissions (to someone) populated for each user (as a
     * sender).
     */
    SUBMISSIONS_PER_USER,

    /**
     * The number of items populated for each shared items set.
     */
    ITEMS_PER_SET,
