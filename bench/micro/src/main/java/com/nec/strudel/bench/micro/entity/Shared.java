...
/**
 * An entity that represents a content shared by many users. There is no
 * particular user who owns this content. Anyone can read and write.
 * 
 * @author tatemura
 *
 */
@Entity
@Indexes({
        @On(property = "setId", auto = true, name = "shared_index")
