...
/**
 * An entity that represents a content that is published by one user and seen by
 * other users. Only the owner has write access to a post.
 * 
 * @author tatemura
 *
 */
@Entity
@Indexes({
        @On(property = "userId", auto = true, name = "post_index")
})
