...
/**
 * Retrieves the information on the auction item of the
 * current interest (specified by AUCTION_ITEM_ID). It
 * retrieves the auction item as well as its seller.
 * If it has been sold, it also retrieves the buyer.
 * The successful result may have the following modes:
 * <ul>
 ...
 * </ul>
 * These values can be used in the next interaction to
 * decide the price to bid or buy.
 */
public abstract class AbstractViewAuctionItem<T> implements Interaction<T> {
	...
	public Result resultOf(AuctionItem item, User seller, BuyNowAuction bna, User buyer,
