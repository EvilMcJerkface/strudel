...
/**
 * Retrieves the existing bids on the current auction
 * item of interest, which is specified by AUCTION_ITEM_ID.
 *
 */
public abstract class AbstractViewAuctionBidHistory<T> implements Interaction<T> {
	...
	public Result resultOf(List<Bid> bids, List<User> bidders, ResultBuilder res) {
