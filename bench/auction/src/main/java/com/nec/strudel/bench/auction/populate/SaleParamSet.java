...
public class SaleParamSet {
    ...
    static class ParamGen {
        ...
        private SaleParam createParam() {
            int num = numOfBns();
            SaleParam param = new SaleParam(num);
            param.setName(name.next(rand));
            param.setPrice(price);
            param.setItemQnty(qnty);
            param.setBuyerIds(buyerIds(num));
            param.setBnsDates(bnsDates(num));
            param.setBnsQnts(bnsQnts(num));
            return param;
        }
