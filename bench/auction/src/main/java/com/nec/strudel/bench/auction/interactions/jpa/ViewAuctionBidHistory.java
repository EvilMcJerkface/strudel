...
public class ViewAuctionBidHistory extends AbstractViewAuctionBidHistory<EntityManager>
implements Interaction<EntityManager> {
	...
	public Result executeWithFind(ItemId itemId, EntityManager em, ResultBuilder res) {
		List<User> bidders = new ArrayList<User>();
		List<Bid> bids = 
				em.createQuery(GET_QUERY, Bid.class)
	...
	public Result executeWithJoin(ItemId itemId, EntityManager em, ResultBuilder res) {
	...
	public Result executeWithFetchJoin(ItemId itemId, EntityManager em, ResultBuilder res) {
		List<User> bidders = new ArrayList<User>();
		List<Bid> bids = 
				em.createQuery(FETCH_JOIN_QUERY, Bid.class)
				.setParameter(P_SELLER, itemId.getSellerId())
				.setParameter(P_ITEM_NO, itemId.getItemNo())
				.getResultList();
