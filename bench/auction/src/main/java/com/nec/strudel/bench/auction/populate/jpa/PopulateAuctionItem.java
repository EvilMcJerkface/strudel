...
public class PopulateAuctionItem
        extends AbstractPopulateAuctionItem<EntityManager>
    ...
    public void process(EntityManager em, AuctionParamSet aps) {
        ...
        for (AuctionParam p : aps.getParams()) {
            ...
            em.persist(item);
            /**
             * NOTE: flush is needed to know the automatically generated value
             * (itemNo) by the above insertion. This value is used for bids and
             * BNAs below:
             */
            em.flush();
    ...
    @Override
    protected List<AuctionItem> getItemsBySeller(EntityManager em,
            int sellerId) {
