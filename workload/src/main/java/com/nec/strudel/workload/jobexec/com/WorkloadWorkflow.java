...
public final class WorkloadWorkflow {
    ...
    public static Command command(Workflow workflow) {
        workflow.addBuilder(WorkloadAction.NAME, new WorkloadAction());
        workflow.addBuilder(MonitorAction.NAME, new MonitorAction());
        return workflow.createCommand();
    }
    ...
    public static class MonitorAction implements ActionBuilder {
        ...
        public void build(ConfigValue action,
            ...
            JmxMonitorConfig spec = action.getObject("resource",
                    JmxMonitorConfig.class);
            TimeValue measureTime = TimeValue
                    .seconds(action.getLong("measure"));
            TimeValue pollTime = TimeValue.seconds(action.getLong("poll"));
    ...
    public static class WorkloadAction implements ActionBuilder {
        ...
        public void build(ConfigValue action,
            ...
            if (WORK_START.equals(com)) {
                ...
                JsonObject param = (JsonObject) action.getJson("arg");
