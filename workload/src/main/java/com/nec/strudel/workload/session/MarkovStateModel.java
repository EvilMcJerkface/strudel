...
public class MarkovStateModel<T> {
    ...
    public static class Builder<T> {
        private final Map<String, MarkovState<T>> states = new HashMap<String, MarkovState<T>>();
        private final List<Transition> trans = new ArrayList<Transition>();

        /**
         * Creates a "transient" state that has no interaction to execute
         * 
         * @param name
         *            the name of the state, which must be unique.
         */
        ...
        protected Builder<T> state(MarkovState<T> state) {
         ...
         *            the current state
         * @param nexts
         *            next states and their probability
         */
    ...
    public static class MarkovState<T> {
        /**
         * The end state has a NULL interaction, which means that the session
         * ends.
         */
        @SuppressWarnings({ "rawtypes", "unchecked" })
        public static final MarkovState END_STATE = new MarkovState(
                MarkovStateModel.END, null, true);
         ...
         * 
         * @param interaction
         * @return a Markov state whose name is same as the interaction's name.
         */
