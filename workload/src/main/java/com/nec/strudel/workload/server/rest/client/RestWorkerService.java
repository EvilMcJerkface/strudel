...
public class RestWorkerService implements WorkerService {
    private static final Logger LOGGER = Logger
            .getLogger(RestWorkerService.class);
    ...
    public WorkStatus init(WorkRequest work) {
        ...
        try {
            ...
            throw new WorkloadException(errorMsg, ex);
        }
    }
    ...
    /**
     * execute the first invocation exclusively (and other invocations
     * non-exclusively) to work around a concurrency issue in
     * org.glassfish.jersey.client.ClientRuntime.invoke()
     * java.lang.IllegalAccessException: Class
     * org.glassfish.hk2.utilities.reflection.ReflectionHelper can not access a
     * member of class org.glassfish.json.jaxrs.JsonStructureBodyWriter with
     * modifiers "private"
     */
    ...
    private WorkStatus toStatus(Response res) {
        ...
        try {
            ...
            LOGGER.error("failed to read the result: "
                    + "media type = " + type, ex);
            return WorkStatus.error(ex.getMessage());
        }
    }
