...
public class UserAction<T> {
    ...
    /**
     * Time to spend after the emulated user chooses this interaction before
     * starting the interaction.
     * <p>
     * In TPC-C, this corresponds to the "keying time," the time for the
     * emulated user to fill an input form.
     * 
    ...
    /**
     * Time to spend after this interaction is done before the user chooses the
     * next interaction.
     * 
