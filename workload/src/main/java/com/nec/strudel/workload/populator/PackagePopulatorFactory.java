...
public class PackagePopulatorFactory<T> implements PopulatorFactory<T> {
    private static final Logger LOGGER = Logger
            .getLogger(PackagePopulatorFactory.class);
    private final Map<String, Populator<T, ?>> pops = new HashMap<String, Populator<T, ?>>();
    ...
    public PackagePopulatorFactory(String packageName, String classPath) {
        ...
        Set<Class<? extends Populator>> clss = refs
                .getSubTypesOf(Populator.class);
