    ...
    public Command createCommand() {
        CommandBuilder builder = new CommandBuilder()
                ...
                .command(WorkGroupCommands
                        .command(MeasureWorkState.COMMAND_MEASURE, input))
